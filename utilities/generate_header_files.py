...
class WorkingSet:
    ...
    def __init__(self):
        ...
        self.fwd_entry_map: dict[str, list[str]] = defaultdict(list)  # A map with all collected fwd entries.
    ...
    def write_include_header(self, target_path: Path, source_path: Path = None):
        ...
        if self.verbose:
            print(f'  writing "{source_path.relative_to(self.project_dir)}" -> "{rel_target_path}"')
