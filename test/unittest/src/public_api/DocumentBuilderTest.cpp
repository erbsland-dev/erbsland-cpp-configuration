...
public:
    ...
    void testAllTypes2() {
        ...
        REQUIRE_NOTHROW(builder.addRegEx(u8"main.value_10", RegEx{u8"abc", false}));
        auto expectedValueMap = ExpectedValueMap{
                {u8"main", u8"SectionWithNames()"},
                {u8"main.value_1", u8"Integer(12345)"},
                {u8"main.value_2", u8"Boolean(true)"},
    ...
    void testAllTypes3() {
        ...
        REQUIRE_NOTHROW(builder.addRegEx(NamePath::fromText(u8"main.value_10"), RegEx{u8"abc", false}));
        auto expectedValueMap = ExpectedValueMap{
                    {u8"main", u8"SectionWithNames()"},
                    {u8"main.value_1", u8"Integer(12345)"},
                    {u8"main.value_2", u8"Boolean(true)"},
