...
public:
    ...
    void testGetInteger() {
        ...
        WITH_CONTEXT(requireFail<String, const String&>(&Value::getTextString, &Value::getTextOrThrow, String{u8"hello"}));
        ...
        WITH_CONTEXT(requireFail<RegEx, const RegEx&>(&Value::getRegEx, &Value::getRegExOrThrow, RegEx{u8"other", false}));
    ...
    void testGetBoolean() {
        ...
        WITH_CONTEXT(requireFail<String, const String&>(&Value::getTextString, &Value::getTextOrThrow, String{u8""}));
    ...
    void testGetText() {
        ...
        const auto path = NamePath::fromText(u8"main.value");
        REQUIRE_EQUAL(doc->getTextString(path, String{}), String{u8"text"});
    ...
    void testGetDate() {
        ...
        WITH_CONTEXT(requireFail<bool, bool>(&Value::getBoolean, &Value::getBooleanOrThrow, false));
        WITH_CONTEXT(requireFail<Float, Float>(&Value::getFloat, &Value::getFloatOrThrow, 0.0));
        WITH_CONTEXT(requireFail<String, const String&>(&Value::getTextString, &Value::getTextOrThrow, String{}));
        WITH_CONTEXT(requireFail<Time, const Time&>(&Value::getTime, &Value::getTimeOrThrow, Time{}));
        // WITH_CONTEXT(requireFail<Date, const Date&>(&Value::getDate, &Value::getDateOrThrow, Date{}));
        WITH_CONTEXT(requireFail<DateTime, const DateTime&>(&Value::getDateTime, &Value::getDateTimeOrThrow, DateTime{}));
        WITH_CONTEXT(requireFail<Bytes, const Bytes&>(&Value::getBytes, &Value::getBytesOrThrow, Bytes{}));
    ...
    void testGetRegEx() {
        ...
        const auto path = NamePath::fromText(u8"main.value");
        const auto expected = RegEx{u8"regex", false};
