...
public:
    ...
    void testTextLong() {
        ...
        REQUIRE(nanosec.textLong() == u8"Nanoseconds");
        REQUIRE(microsec.textLong() == u8"Microseconds");
        REQUIRE(millisec.textLong() == u8"Milliseconds");
        REQUIRE(sec.textLong() == u8"Seconds");
        REQUIRE(min.textLong() == u8"Minutes");
        REQUIRE(hour.textLong() == u8"Hours");
        REQUIRE(day.textLong() == u8"Days");
        REQUIRE(week.textLong() == u8"Weeks");
        REQUIRE(month.textLong() == u8"Months");
        REQUIRE(year.textLong() == u8"Years");
    }
    ...
    void testTextShort() {
        ...
        REQUIRE(nanosec.textShort() == u8"ns");
        REQUIRE(microsec.textShort() == u8"µs");
        REQUIRE(millisec.textShort() == u8"ms");
        REQUIRE(sec.textShort() == u8"s");
        REQUIRE(min.textShort() == u8"m");
        REQUIRE(hour.textShort() == u8"h");
        REQUIRE(day.textShort() == u8"d");
        REQUIRE(week.textShort().empty());
        REQUIRE(month.textShort().empty());
        REQUIRE(year.textShort().empty());
    }
    ...
    void testHashSpecialization() {
        ...
        for (const auto& unit : TimeUnit::all()) {
            unitMap[unit] = unit.textLong().toCharString();
        }
        ...
        for (const auto& unit : TimeUnit::all()) {
            ...
            REQUIRE(it->second == unit.textLong().toCharString());
        }
