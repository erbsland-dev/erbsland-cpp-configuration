...
template<typename T>
[[nodiscard]] auto toTestText(const T &value, TestFormat format) noexcept -> String {
...
template<>
[[nodiscard]] inline auto toTestText(const String &value, TestFormat format) noexcept -> String {
    return u8format(u8"\"{}\"", value.toEscaped(EscapeMode::FullTestAdapter));
}

template<>
[[nodiscard]] inline auto toTestText(const Date &value, TestFormat format) noexcept -> String {
    return value.toText();
}

template<>
[[nodiscard]] inline auto toTestText(const Time &value, TestFormat format) noexcept -> String {
    return value.toText();
}

template<>
[[nodiscard]] inline auto toTestText(const DateTime &value, TestFormat format) noexcept -> String {
    return value.toText();
}

template<>
[[nodiscard]] inline auto toTestText(const Bytes &value, TestFormat format) noexcept -> String {
    return value.toHex();
}

template<>
[[nodiscard]] inline auto toTestText(const TimeUnit &value, TestFormat format) noexcept -> String {
    return value.toTextLowercaseSingular();
}

template<>
[[nodiscard]] inline auto toTestText(const RegEx &value, TestFormat format) noexcept -> String {
