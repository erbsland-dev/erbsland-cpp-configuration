...
void appendCharToBuffer(Buffer &buffer, const char32_t unicode) noexcept {
    const auto u = static_cast<uint32_t>(unicode);
    if (u <= 0x0000007FU) {
        buffer.push_back(static_cast<CharType>(u));
        return;
    }
    if (u <= 0x000007FFU) {
        buffer.push_back(static_cast<CharType>(((u >> 6) & 0b00011111U) | 0b11000000U));
        buffer.push_back(static_cast<CharType>((u        & 0b00111111U) | 0b10000000U));
        return;
    }
    if (u <= 0x0000FFFFU) {
        buffer.push_back(static_cast<CharType>(((u >> 12) & 0b00001111U) | 0b11100000U));
        buffer.push_back(static_cast<CharType>(((u >> 6)  & 0b00111111U) | 0b10000000U));
        buffer.push_back(static_cast<CharType>((u         & 0b00111111U) | 0b10000000U));
        return;
    }
    if (u <= 0x0010FFFFU) {
        buffer.push_back(static_cast<CharType>(((u >> 18) & 0b00000111U) | 0b11110000U));
        buffer.push_back(static_cast<CharType>(((u >> 12) & 0b00111111U) | 0b10000000U));
        buffer.push_back(static_cast<CharType>(((u >> 6)  & 0b00111111U) | 0b10000000U));
        buffer.push_back(static_cast<CharType>((u         & 0b00111111U) | 0b10000000U));
        return;
    }
...
auto Char::escapedUtf8Size(const EscapeMode escapeMode) const noexcept -> std::size_t {
    ...
    const auto hexDigits = (static_cast<std::size_t>(std::bit_width(static_cast<uint32_t>(_unicode))) + 3U) / 4U;
    return std::max<std::size_t>(1U, hexDigits) + 4U;
}
